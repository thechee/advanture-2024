...
class Van(db.Model):
  ...
  def to_dict(self):
    ...
    return {
        ...
        "avgCleanliness": van_avg_cleanliness,
        "avgMaintenance": van_avg_maintenance,
        "avgCommunication": van_avg_communication,
        "avgConvenience": van_avg_convenience,
        "avgAccuracy": van_avg_accuracy,
        "doors": self.doors,
        "seats": self.seats,
        "mpg": self.mpg,
        "lat": self.lat,
